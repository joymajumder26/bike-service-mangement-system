...
<form action="insertemployee.php" method="post" accept-charset="utf-8">	
  <div class="container">
    <h1>Add Employee</h1>    
    <hr>
    ...
    <!--<label for="assignmentid"><b>Assignment</b></label>
    <input type="text" placeholder="Enter Assignment" name="assignmentid" required>-->
